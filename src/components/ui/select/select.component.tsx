...
const Select: React.FC<ISelect> = ({
    name, value, label, placeholder, options, isError, errorMessage, handleChange, disabled
  }) => {
  ...
  return (
    <div className={styles.selectContainer}>
      ...
      <div
        ...
        onClick={!disabled ? toggleSelectOpened : () => {}}
      >
        <p
        ...
        </div>
        {
          isSelectOpened ?
            <div
              className={`customScrollBar ${styles.options}`}
            >
